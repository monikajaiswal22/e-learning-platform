...
class User(UserMixin, db.Model):
    ...
    # Relationships
    enrolled_courses = db.relationship('Enrollment', backref='student', lazy='dynamic', cascade="all, delete-orphan")
    created_courses = db.relationship('Course', backref='instructor', lazy='dynamic', cascade="all, delete-orphan")
...
class Course(db.Model):
    ...
    instructor_id = db.Column(db.Integer, db.ForeignKey('user.id', ondelete='CASCADE'), nullable=False, index=True)
    ...
    # Relationships
    lessons = db.relationship('Lesson', backref='course', lazy='dynamic', cascade="all, delete-orphan", order_by="Lesson.order")
    enrollments = db.relationship('Enrollment', backref='course', lazy='dynamic', cascade="all, delete-orphan")
    reviews = db.relationship('Review', backref='course', lazy='dynamic', cascade="all, delete-orphan")
    wishlisted_by = db.relationship('Wishlist', backref='course', lazy='dynamic', cascade="all, delete-orphan")
...
class Lesson(db.Model):
    ...
    # Relationships
    user_progress = db.relationship('LessonProgress', backref='lesson', lazy='dynamic', cascade="all, delete-orphan")
    ...
    def get_quiz_score_for_user(self, user_id):
...
class Enrollment(db.Model):
    ...
    completed_at = db.Column(db.DateTime, nullable=True)  # ✅ Yeh column database mein hona chahiye
...
class LessonProgress(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    user_id = db.Column(db.Integer, db.ForeignKey('user.id', ondelete='CASCADE'), nullable=False, index=True)
    lesson_id = db.Column(db.Integer, db.ForeignKey('lesson.id', ondelete='CASCADE'), nullable=False, index=True)
...
class Wishlist(db.Model):
    ...
    __table_args__ = (db.UniqueConstraint('user_id', 'course_id', name='unique_wishlist'),)
